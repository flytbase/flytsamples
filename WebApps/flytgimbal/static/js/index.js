       ...
       success: function(data){
           if(data.success){
               ...
               // getParam("SENS_EXT_MAG_ROT");
                ...
                //getParam('ob_track_kp_pos');
                //getParam('ob_track_kd_pos');
...
$("#ob_track_tolerance_outer, #ob_track_tolerance_inner, #ob_track_parameter_p, #ob_track_parameter_i, #ob_track_parameter_d, #ob_track_parameter_kp, #ob_track_parameter_kd, #ob_track_parameter_ki, #ob_track_x_max, #ob_track_gimbal_angle").change(function(){
